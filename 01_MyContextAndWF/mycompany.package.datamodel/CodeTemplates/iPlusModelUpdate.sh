...
databaseConnectionString='data source=gipDLVmSQL1.incus;Initial catalog=ExampleV5;Trusted_Connection=False;Encrypt=False;user id=gip;password=netspirit;'
namespace="mycompany.package.datamodel"
outputDir="EFModels"
compiledOutputDir="EFCompiledModels"
efBaseName="ExampleV5"
